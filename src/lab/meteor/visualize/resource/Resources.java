...
public class Resources {
	...
	public static final ResizableImage IMG_CLASS_BG;
	public static final ResizableImage IMG_ENUM_BG;
	...
	static {
		IMG_CLASS_BG = new ResizableImage(Launcher.getFrame().getGraphicsConfiguration(), new ImageLoader("class_bg.png"), 3, 33, 190, 132);
		IMG_ENUM_BG = new ResizableImage(Launcher.getFrame().getGraphicsConfiguration(), new ImageLoader("enum_bg.png"), 3, 33, 190, 132);
		...
		FONT_PROPERTY = new Font("Consolas", Font.PLAIN, 14);
		FONT_CLASS_ENUM = new Font("Corbel", Font.PLAIN, 18);
